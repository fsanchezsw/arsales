...
class DBHelper(context: Context)
    ...
    companion object {
        ...
        const val CREATE_SALE_TABLE = "CREATE TABLE ${SaleSchema.TABLE_NAME}(" +
            ...
            "${SaleSchema.URL} TEXT NOT NULL, " + "${SaleSchema.IMAGE_URL} TEXT, " + "${SaleSchema.ID_SHOP} INTEGER, " +
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        saleValues1.put(SaleSchema.IMAGE_URL, "bermudas.png")
        ...
        saleValues2.put(SaleSchema.IMAGE_URL, "camiseta.png")
        ...
        saleValues3.put(SaleSchema.IMAGE_URL, "chaqueta.png")
